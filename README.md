...
当前状态：`MVP 0.1 / M3–M6 工程基线` — M6 发布加固（服务包、运维文档、可追溯 meta、验收脚本）已落地，见 [M6_ACCEPTANCE](docs/M6_ACCEPTANCE.md)。合规签字与代码签名仍属人工/授权门禁。M5 证据见 [M5_ACCEPTANCE](docs/M5_ACCEPTANCE.md)；M4 证据见 [M4_CI_RUN](docs/M4_CI_RUN.md)。
## MVP 能力
