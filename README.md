...
当前状态：`MVP 0.1 / M3+M4 验收关闭` — 确定性推荐与公开 API、Tauri 桌面客户端、Win/Linux 原生 E2E 与三平台 bundle CI 已通过（见 [M4_CI_RUN](docs/M4_CI_RUN.md)）。真实多人候选约 2,000+ 条；数据富化与 AI Provider（M5）仍为后续门禁。
## MVP 能力
